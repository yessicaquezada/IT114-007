...
public class Room implements AutoCloseable {
	...
	protected synchronized void sendMessage(ServerThread sender, String message) {
		...
		if (sender != null && sendPrivateMessage(message, sender)) {
			return;
		}
		...
		String regex6 = "\\*\\$";
		String regex7 = "\\$\\*";
		message = message.replaceAll(regex6, "<font color =\"red\">");
		message = message.replaceAll(regex7, "</font>");

		String regex8 = "!#";
		String regex9 = "#!";
		message = message.replaceAll(regex8, "<font color =\"green\">");
		message = message.replaceAll(regex9, "</font>");
	...
	protected synchronized boolean sendPrivateMessage(String message, ServerThread sender) {
